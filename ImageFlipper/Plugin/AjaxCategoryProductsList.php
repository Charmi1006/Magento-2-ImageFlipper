...
namespace MagentoCoders\ImageFlipper\Plugin;
...
class AjaxCategoryProductsList
{
    ...
    public function aroundGetProductDetailsHtml(
        \MagentoCoders\AjaxCategoryProducts\Block\CategoryProducts $subject,
        \Closure $proceed,
        ...
        if ($enable) {
            ...
            if (($flipper_img_name!="no_selection")&&($flipper_img_name!="productno_selection")&&(($flipper_img_name != null))) {
                ...
                $result = $proceed($product);
                return $result . '<span id="magentoCoders_fliper_img" style="display:none;">'.$image_url.'</span>';
            }
        }
        $result = $proceed($product);
        return $result;
